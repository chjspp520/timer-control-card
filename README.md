...
**技术之道，前后分离：**  
前端以 Web Components 为基，后端以 AppDaemon 为柱，实时同步，持久存储。  

**生活之用，场景为要：**  
睡前关灯，节能空调，媒体管理，周期任务，皆可定时。  
...
```bash
# 通过 Home Assistant 重启
service: appdaemon.restart

# 或通过系统服务重启
sudo systemctl restart appdaemon@appdaemon
```
